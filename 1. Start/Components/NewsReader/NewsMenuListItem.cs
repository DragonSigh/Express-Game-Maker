 ...
 * Most Used By:        NewsMenuListCollection.cs
 * Associated Files:    NewsMenuList.cs, NewsMenuListItemCollection.cs
...
{
    public partial class NewsMenuListItem : MarshalByRefObject, ICloneable
    {

        public delegate void ClickeEvent(object sender);
        public event ClickeEvent Clicked;

        public NewsMenuListItem()
        {
            text = "menuListItem";
            isCategory = false;
        }
        public NewsMenuListItem(string t)
        {
            text = t;
            isCategory = false;
        }
        ...
        //    si.AddValue("IsExpanded", this.IsExpanded);
