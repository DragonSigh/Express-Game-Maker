...
namespace EGMGame
{
    public partial class UseSkillMDialog : Form
    {

        public UseSkillMDialog()
        {
            InitializeComponent();
        ...
        private void SetupAction(EventProgramData a)
        {
            ...
            cbListPartyIndex.Select((int)action.Value[2]);
            chkApplyCost.Checked = (bool)action.Value[3];
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            action.Value[2] = cbListPartyIndex.Data().ID;
            action.Value[3] = chkApplyCost.Checked;
