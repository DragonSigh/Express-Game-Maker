...
{
    public partial class ChangeFrictionDialog : Form
    {
        public ChangeFrictionDialog()
        {
            InitializeComponent();
        ...
        public EventPageData SelectedPage
        {
            ...
            {
                selectedPage = value;
                action.Value[1] = selectedPage.Friction;
                action.Value[2] = selectedPage.CustomFriction;
                nudFriction.Value = (decimal)(float)action.Value[1];
                chkFriction.Checked = (bool)action.Value[2];
            }
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    action.Value[1] = (float)nudFriction.Value;
                    break;
                case 1:
            ...
            action.Value[2] = chkFriction.Checked;
            action.Name = "Change Friction: " + nudFriction.Value.ToString();
