...
{
    public partial class ChangeBounceDialog : Form
    {
        public ChangeBounceDialog()
        {
            InitializeComponent();
        ...
        public EventPageData SelectedPage
        {
            ...
            {
                selectedPage = value;
                action.Value[1] = selectedPage.Bounce;
                action.Value[2] = selectedPage.CustomBounce;
                nudBounce.Value = (decimal)(float)action.Value[1];
                chkBounce.Checked = (bool)action.Value[2];
            }
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    action.Value[1] = (float)nudBounce.Value;
                    break;
                case 1:
            ...
            action.Value[2] = chkBounce.Checked;
            action.Name = "Change Bounce: " + nudBounce.Value.ToString();
