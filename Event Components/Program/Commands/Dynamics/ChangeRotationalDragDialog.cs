...
{
    public partial class ChangeRotationalDragDialog : Form
    {
        public ChangeRotationalDragDialog()
        {
            InitializeComponent();
        ...
        public EventPageData SelectedPage
        {
            ...
            set
            {
                ...
                action.Value[1] = selectedPage.RotationalDrag;
                action.Value[2] = selectedPage.CustomRotationalDrag;
                nudRotationalDrag.Value = (decimal)(float)action.Value[1];
                chkRotationalDrag.Checked = (bool)action.Value[2];
            }
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    action.Value[1] = (float)nudRotationalDrag.Value;
                    break;
                case 1:
            ...
            action.Value[2] = chkRotationalDrag.Checked;
            action.Name = "Change Rotational Drag: " + nudRotationalDrag.Value.ToString();
