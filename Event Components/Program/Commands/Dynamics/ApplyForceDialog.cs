...
{
    public partial class ApplyForceDialog : Form
    {
        ...
        private void SetupAction(EventProgramData a)
        {
            ...
            {
                case 0:
                    pixelBox.Value = (decimal)(float)action.Value[4];
                    break;
                case 1:
                    cbVariable.Select((int)(float)action.Value[4]);
                    break;
                case 2:
                    cbLocalVariable.Select((int)(float)action.Value[4]);
                    break;
            }

            turnBox.Checked = (bool)action.Value[5];
            chWait.Checked = (bool)action.Value[6];
            chkMovement.Checked = (bool)action.Value[7];
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    action.Value[4] = (float)pixelBox.Value;
                    break;
                case 1:
                    action.Value[4] = (float)cbVariable.Data().ID;
                    break;
                case 2:
                    action.Value[4] = (float)cbLocalVariable.Data().ID;
                    break;
            }
            action.Value[5] = turnBox.Checked;
            action.Value[6] = chWait.Checked;
            action.Value[7] = chkMovement.Checked;
