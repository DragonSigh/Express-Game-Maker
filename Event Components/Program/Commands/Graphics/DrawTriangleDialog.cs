...
{
    public partial class DrawTriangleDialog : Form
    {
        #region Constructor
        public DrawTriangleDialog()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            CheckDrawTriangleBox();
        }

        private void CheckDrawTriangleBox()
        {
        ...
        private void CheckDrawTriangleUI()
        {
        ...
        {
            action.Name = "Draw Triangle - Start: " + 
