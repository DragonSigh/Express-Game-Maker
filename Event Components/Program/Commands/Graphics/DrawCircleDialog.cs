...
{
    public partial class DrawCircleDialog : Form
    {
        #region Constructor
        public DrawCircleDialog()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void CheckDrawCircleBox()
        {
        ...
        private void CheckDrawCircleUI()
        {
