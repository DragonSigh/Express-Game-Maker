...
namespace EGMGame
{
    public partial class PlayerCommandDialog : Form
    {

        public PlayerCommandDialog()
        {
            InitializeComponent();
        ...
        private void SetupAction(EventProgramData a)
        {
            ...
            cbCommands.SelectedIndex = (int)action.Value[2];
        }
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            ...
            action.Value[2] = cbCommands.SelectedIndex;
