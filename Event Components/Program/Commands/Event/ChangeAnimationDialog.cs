...
{
    public partial class ChangeAnimationDialog : Form
    {
        ...
        {
            if (eventList.Data().ID > -10 && listBox.SelectedIndex > -1 && actionList.SelectedIndex > -1)
            {
                action.Value[0] = eventList.Data().ID;
                action.Value[1] = SelectedAnimation;
                action.Value[2] = SelectedAction;
                action.Name = "Change " + eventList.Data().Name + "'s Animation To " + GameData.Animations[SelectedAnimation].Name + " | " + GameData.Animations[SelectedAnimation].Actions[actionList.SelectedIndex].Name;
        ...
        private void ChangeAnimationDialog_Shown(object sender, EventArgs e)
        {
            ...
            eventList.ThisEvent = true;
            if (selectedEvent == null || selectedEvent is GlobalEventData)
                eventList.RefreshList(false, false, false);
