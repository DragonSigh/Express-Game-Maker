...
namespace EGMGame
{
    public partial class EditDatabaseValueDialog : Form
    {
        ...
        public EditDatabaseValueDialog()
        {
            InitializeComponent();
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            if (propertyBox.Data().ID > -10)
            {
                ...
                if (propertyBox.Data().ValueType == DataType.Number)
                {
                    ...
                    action.Name = "Database: " + GetDataName() + " " + GetOperator() + " " + GetTypeOperator(); ;
                ...
                else if (propertyBox.Data().ValueType == DataType.Text)
                {
                    ...
                    action.Name = "Database: " + GetDataName() + " = " + textBox.Text;
                    action.GetName(selectedEvent, selectedPage);
                    // Close
                    this.DialogResult = DialogResult.OK;
                }
