    ...
    public partial class EditListDialog : Form
    {
        ...
        private void SetupAction(EventProgramData a)
        {
            ...
            switch ((int)action.Value[2])
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    variablesList.SelectedIndex = Global.GetIndex((int)action.Value[3], GameData.Variables);
                    break;
                case 3:
                    localVariableList.SelectedIndex = Global.GetIndex((int)action.Value[3], selectedEvent.Variables);
                    break;
                case 4:
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            if (addRemoveList.SelectedIndex > -1)
            {
                ...
                action.Name = "List " + GameData.Lists[addRemoveList.SelectedID].Name + " " + GetOperator() + " " + GetTypeOperator();
