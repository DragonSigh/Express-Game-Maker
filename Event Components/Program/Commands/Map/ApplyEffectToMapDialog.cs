...
namespace EGMGame
{
    public partial class ApplyEffectToMapDialog : Form
    {
        bool allowChange = true;

        public ApplyEffectToMapDialog()
        {
            InitializeComponent();
        ...
        private void SetupAction(EventProgramData a)
        {
            ...
            cbEffects.Select((int)action.Value[0]);
            parameters = Global.Duplicate<List<EffectParam>>(action.Value[1]);
        ...
        {
            action.Value[0] = cbEffects.Data().ID;
            action.Value[1] = parameters;
