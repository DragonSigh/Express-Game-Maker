...
{
    public partial class ItemHotkeyDialog : Form
    {
        internal List<Hotkey> Keys;
        bool allowChange = true;
        public ItemHotkeyDialog()
        {
            InitializeComponent();
        }
        ...
        private void SetupProperty(Hotkey hotkey)
        {
            ...
            if (hotkey != null)
            {
                ...
                cbItems.Select(hotkey.DefaultID);
            }
            else
            {
        ...
        private void cbItems_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (addRemoveList1.Data().ID > -1 && allowChange)
            {
                addRemoveList1.Data<Hotkey>().DefaultID = cbItems.Data().ID;
            }
        }
    }
}
