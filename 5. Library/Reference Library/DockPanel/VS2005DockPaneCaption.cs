		...
		private static string ToolTipClose
		{
			...
			{	
				if (_toolTipClose == null)
					_toolTipClose = EGMGame.Properties.Resources.DockPaneCaption_ToolTipClose;
        ...
        private static string ToolTipOptions
        {
            get
            {
                if (_toolTipOptions == null)
                    _toolTipOptions = EGMGame.Properties.Resources.DockPaneCaption_ToolTipOptions;
		...
		private static string ToolTipAutoHide
		{
			...
			{	
				if (_toolTipAutoHide == null)
					_toolTipAutoHide = EGMGame.Properties.Resources.DockPaneCaption_ToolTipAutoHide;
