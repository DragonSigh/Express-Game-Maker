...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class FloatWindow : Form, INestedPanesContainer, IDockDragSource
	{
		...
		{
			if (dockPanel == null)
				throw(new ArgumentNullException(EGMGame.Properties.Resources.FloatWindow_Constructor_NullDockPanel));
        ...
        {
            this.Opacity = DockPanel.FloatingWindowInactiveOpacity;
        }
        // CHANGE
        private void Opaque()
        {
