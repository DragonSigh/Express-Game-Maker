    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        public DockContentHandler(Form form, GetPersistStringCallback getPersistStringCallback)
        {
            if (!(form is IDockContent))
                throw new ArgumentException(EGMGame.Properties.Resources.DockContent_Constructor_InvalidForm, "form");
        ...
        public double AutoHidePortion
        {
            ...
            {
                if (value <= 0)
                    throw (new ArgumentOutOfRangeException(EGMGame.Properties.Resources.DockContentHandler_AutoHidePortion_OutOfRange));
        ...
        public DockAreas DockAreas
        {
            ...
            set
            {
                ...
                if (!DockHelper.IsDockStateValid(DockState, value))
                    throw (new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_DockAreas_InvalidValue));
        ...
        public bool IsFloat
        {
            ...
            set
            {
                ...
                if (visibleState == DockState.Unknown)
                    throw new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_IsFloat_InvalidValue);
            ...
            set
            {
                ...
                if (value != null)
                {
                    if (value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_DockPane_InvalidValue);
                }
        ...
        public DockPane FloatPane
        {
            ...
            set
            {
                ...
                {
                    if (!value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_FloatPane_InvalidValue);
                }
        ...
        internal void SetDockState(bool isHidden, DockState visibleState, DockPane oldPane)
        {
            ...
            if (DockPanel == null && visibleState != DockState.Unknown)
                throw new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_SetDockState_NullPanel);

            if (visibleState == DockState.Hidden || (visibleState != DockState.Unknown && !IsDockStateValid(visibleState)))
                throw new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_SetDockState_InvalidState);
        ...
        public DockState ShowHint
        {
            ...
            set
            {
                if (!DockHelper.IsDockStateValid(value, DockAreas))
                    throw (new InvalidOperationException(EGMGame.Properties.Resources.DockContentHandler_ShowHint_InvalidValue));
        ...
        {
            if (dockPanel == null)
                throw (new ArgumentNullException(EGMGame.Properties.Resources.DockContentHandler_Show_NullDockPanel));



            if (DockState == DockState.Hidden || VisibleState == DockState.Unknown)
        ...
        public void Show(DockPanel dockPanel, DockState dockState)
        {
            ...
            if (dockState == DockState.Unknown || dockState == DockState.Hidden)
                throw (new ArgumentException(EGMGame.Properties.Resources.DockContentHandler_Show_InvalidDockState));
        ...
        {
            if (pane == null)
                throw (new ArgumentNullException(EGMGame.Properties.Resources.DockContentHandler_Show_NullPane));

            if (beforeContent != null && pane.Contents.IndexOf(beforeContent) == -1)
                throw (new ArgumentException(EGMGame.Properties.Resources.DockContentHandler_Show_InvalidBeforeContent));
        ...
        public void Show(DockPane previousPane, DockAlignment alignment, double proportion)
        {
            if (previousPane == null)
                throw (new ArgumentException(EGMGame.Properties.Resources.DockContentHandler_Show_InvalidPrevPane));
        ...
        {
            if (panel != DockPanel)
                throw new ArgumentException(EGMGame.Properties.Resources.IDockDragSource_DockTo_InvalidPanel, "panel");
