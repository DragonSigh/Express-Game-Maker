...
namespace EGMGame
{
    public class ExMath
    {
        ...
        /// <returns></returns>
        internal static Vector2 Round(Vector2 value)
        {
            return new Vector2((float)Math.Round((decimal)value.X), (float)Math.Round((decimal)value.Y));
        }
        /// <summary>
        /// Add Vector
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        internal static int ToInt(Vector2 value)
        {
        ...
        /// <returns></returns>
        internal static int GetDistance(Vector2 p1, Vector2 p2)
        {
            int x, y;
            x = (int)(p1.X - p2.X) ^ 2;
            y = (int)(p1.Y - p2.Y) ^ 2;
