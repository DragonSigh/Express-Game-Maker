    ...
    public partial class XnaViewer : UserControl
    {
        ...
        private void UpdateScrollbarsH()
        {
            ...
            if (camera.ViewingHeight > camera.Viewport.Height / zoomLevel)
            {
                ...
                vScrollBar.LargeChange = 0; // TODO
                vScrollBar.SmallChange = 0; // TODO
        ...
        private void UpdateScrollbarsW()
        {
            ...
            if (camera.ViewingWidth > camera.Viewport.Width / zoomLevel)
            {
                ...
                hScrollBar.LargeChange = 0; // TODO
                hScrollBar.SmallChange = 0; // TODO
        ...
        private void graphicsControl_OnDraw(object sender, EventArgs e)
        {
            ...
            //{
            //    // Draw 4 dir
            //    Texture2D dir = Loader.LoadStreamTexture(graphicsDevice, global::ExpressGameMaker.Properties.Resources.fourDCursor, ImageFormat.Png);
