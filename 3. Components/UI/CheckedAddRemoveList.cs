...
{
    public partial class CheckedAddRemoveList : UserControl, IAddRemoveList
    {
    ...
    public class CheckedAddRemoveListEventArgs : EventArgs
    {
        public int Index;
        public TreeNode Node;

        public CheckedAddRemoveListEventArgs(int i, TreeNode n)
        {
            Index = i;
            Node = n;
        }
