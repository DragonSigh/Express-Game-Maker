...
{
    public partial class ImpactAngleSelector : UserControl
    {
        private int angle;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //if (anglePoint.Y > 0)
            //    anglePoint.Y = -anglePoint.Y;
            //else 
            //if (anglePoint.Y < 20 && anglePoint.Y >= 0)
            //    anglePoint.Y += 20;
            //else if (anglePoint.Y < 40 && anglePoint.Y >= 20)
            //    anglePoint.Y -= 20;
            //    if (anglePoint.Y < 0)
            //    anglePoint.Y = Math.Abs(anglePoint.Y);
