...
{
    public partial class SpriteGridControl : UserControl
    {
        #region Fields
        ...
        private void DrawSelected()
        {
            ...
            Rectangle r = SelectedSprite.DisplayRect;
            System.Drawing.RectangleF selectionRect = new System.Drawing.RectangleF(r.X, r.Y, r.Width, r.Height);
        ...
        {
            Texture2D tex = GetTexture(SelectedSprite);
            for (int x = 0; x <= tex.Width; x += SelectedSprite.DisplayRect.Width)
            {
                // Horizontal
                if (x == 0)
                {
            ...
            // Vertical
            for (int y = 0; y <= tex.Height + 1; y += SelectedSprite.DisplayRect.Height)
            {
                if (y == tex.Height)
                {
