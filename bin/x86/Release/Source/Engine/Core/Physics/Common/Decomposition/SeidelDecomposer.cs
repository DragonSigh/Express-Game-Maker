...
namespace FarseerPhysics.Common.Decomposition
{
    ...
    /// See also: "Computational Fixtureetry", 3rd edition, by Mark de Berg et al, Chapter 6.2
    ///           "Computational Fixtureetry in C", 2nd edition, by Joseph O'Rourke
    /// </summary>
    ...
    internal class MonotoneMountain
    {
        ...
        // See "Computational Fixtureetry in C", 2nd edition, by Joseph O'Rourke, page 52
        public void Process()
        {
    ...
    // See "Computational Fixtureetry", 3rd edition, by Mark de Berg et al, Chapter 6.2
