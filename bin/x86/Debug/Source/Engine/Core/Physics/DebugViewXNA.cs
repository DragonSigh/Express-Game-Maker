...
namespace FarseerPhysics.DebugViews
{
    ...
    public class DebugViewXNA : DebugView, IDisposable
    {
        ...
        public static List<RayCastInput> RayCastInputs = new List<RayCastInput>();
        public static bool RecordRay;
        //Contacts
        ...
        //Debug panel
#if XBOX
        public Vector2 DebugPanelPosition = new Vector2(55, 10);
#else
        public Vector2 DebugPanelPosition = new Vector2(40, 10);
#endif
...
#if XBOX
        public Rectangle PerformancePanelBounds = new Rectangle(265, 10, 200, 100);
#else
        public Rectangle PerformancePanelBounds = new Rectangle(250, 10, 200, 100);
#endif
        ...
        private void DrawDebugData()
        {
            ...
            if ((Flags & DebugViewFlags.DebugPanel) == DebugViewFlags.DebugPanel)
            {
                ...
                foreach (RayCastInput input in RayCastInputs)
                {
                    DrawSegment(input.Point1, input.Point2, Color.Yellow);
                }
            }
        ...
        public void LoadContent(GraphicsDevice device, ContentManager content)
        {
            ...
            _font = content.Load<SpriteFont>("SystemFont.spritefont");
        }
